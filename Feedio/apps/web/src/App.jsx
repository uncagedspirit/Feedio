...
import { IlluPageNotFound, IlluPaymentSuccess } from './components/illustrations'
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-white z-50">
      <div className="flex flex-col items-center gap-4">
        <div className="w-10 h-10 rounded-xl bg-[#1a2e28] flex items-center justify-center animate-pulse">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#CCFBF1" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="bg-amber-50 border-b border-amber-200">
      <div className="max-w-6xl mx-auto px-5 py-2 flex items-center justify-between gap-4">
        <p className="text-[12px] text-amber-700">
          ...
          Add <code className="bg-amber-100 px-1 rounded text-[11px]">VITE_SUPABASE_URL</code> to
          {' '}<code className="bg-amber-100 px-1 rounded text-[11px]">.env</code> to connect a real backend.
        </p>
        <button
            ...
            component={() => (
              <div className="min-h-[80vh] flex items-center justify-center">
                <div className="text-center">
                  <div className="flex justify-center mb-4"><IlluPageNotFound size={100} /></div>
                  <h1 className="text-[22px] font-extrabold text-[#111827] mb-2">Page not found</h1>
                  <p className="text-[13px] text-[#9CA3AF] mb-6">The page you're looking for doesn't exist.</p>
                  <a href="/" className="inline-flex items-center gap-2 bg-[#1a2e28] text-white text-[13px] font-semibold px-5 py-2.5 rounded-xl hover:bg-[#243d35] transition-colors cursor-pointer">
                    Go home
                  </a>
                </div>
              </div>
